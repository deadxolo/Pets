    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-primary-600 to-primary-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">Complete Pet Care Solution</h1>
          <p className="text-xl mb-8">Medical services, grooming, training, and quality products for your beloved pets</p>
          <div className="flex justify-center space-x-4">
            <Link to="/services" className="bg-white text-primary-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              Our Services
            </Link>
